...
const ShotCard = ({ shot, index }: { shot: any, index: number }) => {
  ...
  return (
    <div className="w-[280px] flex-shrink-0 bg-[#1C1C22]/60 border border-gray-700 rounded-lg p-3 space-y-3 relative group">
      ...
      <div className="flex items-center justify-between gap-2 pt-2 border-t border-gray-700">
        <Button variant="ghost" className="text-xs text-white hover:bg-gray-700 hover:text-white w-full">
